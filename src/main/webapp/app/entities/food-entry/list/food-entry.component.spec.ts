...
describe('Component Tests', () => {
  describe('FoodEntry Management Component', () => {
    let comp: FoodEntryComponent;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(FoodEntryComponent, '')
        .compileComponents();
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.foodEntries[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });
