...
import com.ava.foodlogger.service.FoodService;
import com.ava.foodlogger.service.dto.FoodDTO;
import com.ava.foodlogger.service.mapper.FoodMapper;
...
class FoodResourceIT {
    ...
    void partialUpdateFoodWithPatch() throws Exception {
        ...
        partialUpdatedFood.calories(UPDATED_CALORIES).proteins(UPDATED_PROTEINS);
